...
Note that you _only create a mockup_. The content does not have to be dynamic. We will do that in a later lab.
...
- The shop content:
  ...
  - Discount batch should be located 30px from the top and right side of the frame around the image.
    _Hint: Images with the same dimension will make the design easier._
...
Merk at i du _bare lager en "mockup"_. Innholdet trenger ikke å være dynamisk. Vil vil gjøre de i en senere lab.
